...
\begin{enumerate}
    ...
    The \A{concept} and \mbox{Persoon}, \mbox{Inschrijving}, \mbox{Registratie} with management and Discipline(Tucht) with measures.
...
%    \item rq3-5 12-9 Jurisprudentie buiten scope houden.
%    \newline\textbf{obs}: is geen observatie maar een mening !!!
    ...
    \item rq3-9:19-9: The structure of the \A{register}s is the same, registration is also called registration
...
%    \newline\textbf{obs}: geen observatie maar meer scoping
    ...
    Some knowledge of the \A{law} or the process means that your own \A{interpretation} is quickly made.
