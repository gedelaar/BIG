...
\begin{enumerate}
    ...
    \newline\textbf{obs}: Disciplinary law is not easy to capture in \A{concept} and \A{relation}s.
    ...
    \item rq2-17:11-11/14-11: Is there a difference between the \A{concept} entry and the draft entry.
    ...
    \item rq2-18:16-11: Good to realize that the \A{meaning} you write down also ends up in the \A{Conceptual analysis}.
