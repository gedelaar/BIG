\subsection{Laws} \label{subsection:law}
...
In the Netherlands, the tax authorities have also devised a method for analyzing laws, so they have developed a method~\citepNonPub{ausems_wetsanalyse_2021} that is intended to analyse tax laws and other laws.
