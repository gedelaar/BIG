...
Within this ministry, the implementing organization \acrshort{cibg} is responsible for managing the register.
The \acrshort{cibg} monitors all aspects that a register system must comply with.
...
The \acrshort{cibg} has asked whether it is possible to translate directly from the legislation and regulations into a design and possible implementation.
...
The involvement of the \acrshort{cibg} organization is essential for this validation process.
...
The demand and the support comes from the \acrshort{cibg} organization.
...
commentaar van Stef Joosten (dd 14-1-22) hierop
    ...
    Over de introductie: De huidige redeneerlijn in de introductie is:
        ...
        vierde alinea: noemt de belanghebbende, \acrshort{cibg}, en stelt dat we Ampersand gaan gebruiken.
...
\end{comment}
%v
Ampersand~\citep{joosten_software_2017} will be used to specify registration systems.
