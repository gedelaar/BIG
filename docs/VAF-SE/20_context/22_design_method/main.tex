...
% SJ 2021-12-13
% Het bovenstaande klinkt alsof je een keuze hebt gemaakt voor Ampersand. Dat is niet zo.
% De onderzoeksvraag is "Hoe bruikbaar is Ampersand in een realistische situatie?" Om die reden moet je Ampersand inleiden.
% Het is daarbij natuurlijk nuttig om iets te vertellen over relatiealgebra,
% maar vergeet niet om te vertellen wat Ampersand beoogt (het ontwerpen van informatiesystemen, zodat de lezer straks begrijpt waarom je een informatiesysteem voor BIG ontwerpt),
% wat Ampersand belooft en niet belooft (omdat je die beloftes in dit onderzoek gaat toetsen).
% Op deze plek draag je dus bij aan de rode draad in je verhaal.
...
% SJ 2021-12-13
% Bovenstaande stelling is onjuist. De relatiealgebra definieert operaties op relaties. Omdat elke relatie kan worden opgevat als een verzameling van tweetallen zijn relaties ook verzamelingen.
% In Ampersand zie je dat terug omdat voor elke relatie $r[S*T]$ geldt dat $r\subseteq S\times T$ (waarbij $\times$ het cartesisch product is. Dat betekent: $a\in S\wedge b\in T\ \Rightarrow\ (a,b)\in S\times T$).
% Daarom verwacht je in de relatiealgebra ook de verzamelingenoperatoren zoals $\cup$, $\cap$ en $-$.
%
...
% De volgende zin hoort niet thuis in een bespreking van relatiealgebra.
